...
var config = require('./config/'+ 'qianjia' +'_config');
...
var commonsPlugin = new webpack.optimize.CommonsChunkPlugin({
    ...
    filename: isOnline ? dir.js+'vendors.[hash:5].js' : dir.js+'vendors.js'
...
var indexHtml = new HtmlWebpackPlugin({
    ...
    hash: true,
    socketJs: '<script src="_socket_.js"></script>'
});
...
const devWebpackConfig = {
  ...
  output: {
      ...
      publicPath: isOnline ? '' : 'http://'+ rera.config.host +':'+ rera.config.port +'/'
  },
  resolve: {
